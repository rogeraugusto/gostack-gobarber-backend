...
describe('SendForgotPasswordEmail', () => {
  ...
  it('should not be able to reset the password after 2 hours', async () => {
    ...
    // A função Date.now, retorna o timestamp atual.
    // O mockImplementationOnce, permite alterar o valor retornado pela função no spyOn
    // Nesse caso, será retornado um valor no futuro, simulando o token depois de 2hs
